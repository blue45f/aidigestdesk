...
export const learningResources: LearningResource[] = [
  ...
  },
  {
    ...
    author: 'Fast Campus, Codeit, Sparta, Elice, Programmers, goorm, Udemy, Multicampus, Wanted',
    language: '한국어',
    level: '입문',
    summary:
      '인프런 외에도 패스트캠퍼스, 코드잇, 스파르타코딩클럽, 엘리스, 프로그래머스, 구름EDU/KDT, Udemy 한국어, 멀티캠퍼스, 원티드 프리온보딩의 AI 코딩·LLM·업무 자동화 강좌 후보를 함께 추적한다.',
    url: 'https://fastcampus.co.kr',
    sourceIds: [
      'fastcampus-ai',
      'codeit-ai',
    ...
    tags: ['한국어', '강좌 플랫폼', '인프런 대체', '원격 교육', 'K-디지털', 'AI 코딩'],
  },
  {
    ...
    author:
      'Inflearn, Fast Campus, Codeit, Sparta, Elice, Programmers, goorm, Nomad Coders, Dream Coding, CLASS101, Coloso, Udemy, Multicampus, Wanted',
    language: '한국어',
    level: '입문',
    summary:
      '인프런 검색 허브와 패스트캠퍼스, 코드잇, 스파르타코딩클럽, 엘리스, 프로그래머스, 구름EDU/KDT, 노마드코더, 드림코딩, 클래스101, 콜로소, Udemy 한국어, 멀티캠퍼스, 원티드 프리온보딩을 함께 비교한다. 바이브 코딩, Cursor, Claude Code, Codex, GitHub Copilot, LangChain, RAG, 업무 자동화 강좌를 유료/무료, 온라인/부트캠프, 입문/실무 기준으로 찾는 용도.',
    url: 'https://www.inflearn.com/search?s=AI%20%EC%BD%94%EB%94%A9',
    sourceIds: [
      'inflearn-ai-coding',
  ...
  },
  {
    ...
    providerIds: ['openai', 'anthropic', 'google', 'cursor', 'qwen'],
    tags: ['한국어', '부트캠프', 'SSAFY', 'SW마에스트로', 'SeSAC', '카카오테크', '모집 상태'],
  },
  {
