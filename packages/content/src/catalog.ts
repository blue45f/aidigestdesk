...
export const benchmarkEntries: BenchmarkEntry[] = [
  ...
  },
  {
    ...
    domain: "overall",
    metric:
      "Benchmark task ambiguity, environment dependency, grading logic audit",
    score: "168",
...
export const learningResources: LearningResource[] = [
  ...
  },
  {
    ...
    author:
      "Boostcamp, SSAFY, AI·SW Maestro, SeSAC, Kakao Tech Bootcamp, goormthon Training, Programmers DevCourse, Code States",
    language: "한국어",
    level: "실무",
    summary:
      "부스트캠프 AI Tech/Web·Mobile, 삼성청년SW아카데미 SSAFY, AI·SW마에스트로, 서울시 SeSAC, 카카오테크 부트캠프, 구름톤 트레이닝, 프로그래머스 데브코스, 코드스테이츠를 모집 상태·과정 분야·온라인 여부·취업 연계 기준으로 추적한다.",
    url: "https://boostcamp.connect.or.kr/",
    sourceIds: [
      "boostcamp-ai-tech",
      "ssafy-official",
  ...
  },
  {
    ...
    author:
      "LangChain, LangGraph, LlamaIndex, Pydantic AI, CrewAI, AutoGen, Mastra",
    language: "영어",
    level: "실무",
    summary:
  ...
  },
  {
    ...
    author:
      "SWE-bench Live, SWE-Bench Illusion, UTBoost, Automated Benchmark Auditing",
    language: "영어",
    level: "고급",
    summary:
