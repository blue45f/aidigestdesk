...
export const learningResources: LearningResource[] = [
  ...
  },
  {
    ...
    author:
      "SWE-bench, Dialogue-SWEBench, SWE Context Bench, SWE-Bench Mobile, SWE-MERA, LiveCodeBench, Aider, BigCodeBench, BFCL, Terminal-Bench, OSWorld",
    language: "영어",
    level: "고급",
    summary:
      "SWE-bench, 대화형 SWE, 경험 재사용, 모바일 앱 개발, 동적 평가, LiveCodeBench, Aider Polyglot, BigCodeBench, BFCL, Terminal-Bench, OSWorld, WebArena를 코딩/에이전트 평가 근거로 묶어 추적한다.",
    url: "https://www.swebench.com/",
    sourceIds: [
...
export const curationMonitors: CurationMonitor[] = [
  ...
  },
  {
    ...
    nextCheck: "2026-06-20",
    nextAction:
      "SWE-bench, Dialogue-SWEBench, SWE Context Bench, SWE-Bench Mobile, SWE-MERA, LiveCodeBench, Aider, BigCodeBench, BFCL, Terminal-Bench, OSWorld, WebArena, MMMU, DocVQA, ChartQA의 신규 리더보드/평가 버전 확인",
    automationHint:
...
export const updatePipeline: UpdatePipelineItem[] = [
  ...
  },
  {
    ...
    summary:
      "종합, 코딩, 대화형/경험 재사용 SWE, 모바일 개발, 동적 SWE, 함수 호출, 터미널/브라우저 에이전트, 문서/PPT류 멀티모달 벤치마크의 rank, score, price, speed, latency, 데이터셋 규모 변동을 요약한다.",
    acceptance: [
